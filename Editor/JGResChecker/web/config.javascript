...
RefTypeNavConfig	 = [
	...
	{navType: NavType.RefType 		, name:"CustomDir"		, cnname: "自定义选择资源"		, typeVal: RefType.CustomDir,		cls: "text-dsbd-red"}
	];
...
AssetTypeNavConfig	 = [
	...
	{navType: NavType.AssetType 		, name:"FBX"		, cnname: "FBX"				, typeVal: AssetType.FBX 		},
