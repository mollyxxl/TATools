...
{
    [MenuItem("Assets/Create/Shader/Shader Lib(*.cginc)")]
    static void CreateShaderLibs()
    {
        ProjectWindowUtilEx.CreateScriptUtil(@"Templates\Shaders\ShaderLib\CustomLib.cginc.txt", "CustomLib.cginc");
    }
