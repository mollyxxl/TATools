...
public class EffectEvla {
    ...
    {
        _camera = camera;
       // camera.SetReplacementShader(Shader.Find("Biwu2/Camera/OverDraw"), "");
    }
    ...
    public void GetOverDrawData(Texture2D texture, out long pixTotal, out long pixActualDraw)
    {
        ...
        //Debug.Log("pixTotal: " + pixTotal + "  pixActualDraw: " + pixActualDraw + "rate" + pixActualDraw * 1.0f / pixTotal);
    }


    public int DrawPixTimes(float r, float g, float b)
    {
        //fixed4(0.1, 0.04, 0.02, 0);
